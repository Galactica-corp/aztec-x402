...
describe("ExactAztecFacilitatorScheme", () => {
  ...
  describe("preparePayment", () => {
    it("generates a commitment and returns it as extra data", async () => {
      ...
      expect(signer.prepareCommitment).toHaveBeenCalledWith(TOKEN_ADDRESS);
    });
  ...
  describe("verify", () => {
    ...
    beforeEach(async () => {
      await scheme.preparePayment(TOKEN_ADDRESS);
    });
    ...
    it("verifies payment using commitment pattern (no registerSender needed)", async () => {
